export const tools = [
  ...
  {
    name: "list_practice_exams",
    description:
      "List practice exams for the user. Returns id, title, folder_id, folder_name, and attempt counts. " +
      "Use this to find practice exams before opening or discussing progress.",
    input_schema: {
      type: "object",
      properties: {
        folder_id: {
          type: "string",
          description:
            "Only return exams for this folder. Omit to list all practice exams.",
        },
      },
    },
  },
  {
    name: "get_progress",
    description:
      "Get the user's practice exam progress: total attempts, average score, best score, " +
      "recent completed attempts, and exam performance. Use when the user asks about progress or scores.",
    input_schema: {
      type: "object",
      properties: {},
    },
  ...
  {
    name: "navigate_to_practice_exam",
    description:
      "Open a practice exam so the user can take it. Use list_practice_exams to find exam IDs.",
    input_schema: {
      type: "object",
      properties: {
        exam_id: { type: "string", description: "ID of the practice exam" },
      },
      required: ["exam_id"],
    },
  },
  {
    ...
    description:
      "Generate a new practice exam for a folder. The folder must have an outline with objectives. " +
      "This can take 30-60 seconds. Use list_folders and get_folder_status first.",
    input_schema: {
      type: "object",
      properties: {
        folder_id: { type: "string", description: "ID of the folder" },
  ...
  {
    name: "navigate_to_progress",
    description:
      "Open the Progress page where the user can see charts and stats for practice exams.",
    input_schema: {
      type: "object",
      properties: {},
    },
